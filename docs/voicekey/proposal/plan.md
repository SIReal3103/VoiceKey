...
- **Claim boundary v1.4:** hạ các cụm “stable/deterministic/local” thành yêu cầu thiết kế và release gate; không trình bày route USB, lợi thế microphone, offline egress hay latency như kết quả OneVoice đã đo. Sửa mô tả `whisper.cpp` và citation TTS không chính xác trong research.
